...
def fit(train_ds, test_ds, steps, g_opt, d_opt, checkpoint, gen, disc):
    ...
    for step, (input_image, target) in train_ds.repeat().take(steps).enumerate():
        ...
        train_step(input_image, target, step, g_opt, d_opt, gen, disc)
...
if __name__ == '__main__':
    ...
    checkpoint = tf.train.Checkpoint(generator_optimizer=generator_optimizer,
                                     ...
                                     generator=generator,
                                     discriminator=discriminator)
    fit(train_dataset, test_dataset, 40000, generator_optimizer, discriminator_optimizer, checkpoint, generator, discriminator)
